...
ZRAM_BULK_PERCENT=""
SWAP_BULK_MB=""
# Согласие на рекомендованные vm.swappiness / vm.vfs_cache_pressure.
# Спрашивается заранее, вместе с остальными вопросами пункта zram: в пакетном
# режиме ask_yn вопросов не задаёт вовсе, и раньше эта рекомендация тихо
# не применялась на любой машине, где значения хоть немного отличались
# от заводских 60/100
SYSCTL_BULK=""
